...
type Page = 'funnel' | 'advertising' | 'forecast' | 'bookings' | 'profile';
...
function AppContent() {
  ...
  const [serviceTypes, setServiceTypes] = useState<any[]>([
    { id: "st_wedding", name: "Wedding Photography", tracksInFunnel: true },
    { id: "st_engagement", name: "Engagement Photography", tracksInFunnel: true },
  ])
