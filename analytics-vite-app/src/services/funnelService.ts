    ...
    try {
      ...
      const { error } = await supabase
        ...
        .upsert({
          ...
          confirmed_available: funnelData.confirmedAvailable ?? 0,
          calls_booked: funnelData.callsBooked || 0,
          calls_cancelled: funnelData.callsCancelled ?? 0,
          calls_no_shows: funnelData.callsNoShows != null ? funnelData.callsNoShows : null,
